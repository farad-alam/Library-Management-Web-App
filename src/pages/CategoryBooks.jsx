        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <div className="text-sm text-base-content/80">Total Books</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-green-600 mb-1">
                {categoryBooks.filter((book) => book.quantity > 0).length}
              </div>
              <div className="text-sm text-base-content/80">Available Now</div>
            </div>
            <div className="text-center">
              ...
              <div className="text-sm text-base-content/80">Average Rating</div>
            </div>
          </div>
        </motion.div>
      </div>
