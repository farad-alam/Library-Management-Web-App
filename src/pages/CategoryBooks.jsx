      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm text-gray-600">
                {categoryBooks.filter(book => book.quantity > 0).length} available
              </div>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            {category.description} Our {category.name.toLowerCase()} collection features carefully selected titles 
            that offer both entertainment and educational value. Whether you're looking for your next great read 
            or researching a specific topic, you'll find quality books that meet your needs.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-yellow-600 mb-1">
                {(categoryBooks.reduce((sum, book) => sum + book.rating, 0) / categoryBooks.length || 0).toFixed(1)}
              </div>
